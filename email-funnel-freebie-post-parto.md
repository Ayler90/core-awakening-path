...
> L'email 8 è la chiusura del funnel con caso studio e CTA consulenza.
>
> Sostituisci tutti i placeholder `[IN MAIUSCOLO]` con i contenuti reali prima dell'invio.

---

## Panoramica della sequenza

| # | Timing | Oggetto | Obiettivo |
|---|--------|---------|-----------|
| 1 | Giorno 0 (subito dopo iscrizione) | Eccoti il Giorno 1, {$name} | Consegnare il primo video + accogliere |
| 2 | Giorno 1 (+24h) | Il modo in cui stai nel corpo è cambiato. Eccoti il Giorno 2 | Giorno 2 + creare connessione |
| 3 | Giorno 2 (+24h) | {$name}, stai respirando nel modo giusto? | Giorno 3 + curiosità |
| 4 | Giorno 3 (+24h) | Il pavimento pelvico non è solo "stringere" | Giorno 4 + sfatare mito |
| 5 | Giorno 4 (+24h) | La pancia dopo il parto: quello che nessuno spiega | Giorno 5 + intro consulenza |
| 6 | Giorno 5 (+24h) | {$name}, questo è il momento giusto | Giorno 6 + perché agire ora |
| 7 | Giorno 6 (+24h) | Per chi è pensata la consulenza (e cosa faremo insieme) | Giorno 7 + per chi è la consulenza |
| 8 | Giorno 7 (+2/3 giorni) | Da dove si riparte davvero, {$name} | Recap + caso studio + CTA consulenza |
...
| Elemento | Placeholder da sostituire |
|----------|--------------------------|
| Link video giornalieri | `[LINK VIDEO GIORNO X]` |
| Link canale Telegram | `[LINK CANALE TELEGRAM]` |
| Link prenotazione consulenza | `[LINK CONSULENZA]` |
| Caso studio (email 8) | `[NOME/INIZIALE]`, `[X mesi/anni]`, `[X settimane/mesi]`, `[CITAZIONE REALE]` |
| Timing sequenza | Adatta i giorni di invio alla tua piattaforma email (MailerLite, ecc.) |

> **Nota sul conteggio:** la sequenza è di 8 email, non 7. Le email 1–4 coprono i giorni 1–4 della guida, le email 5–7 coprono i giorni 5–7 con l'introduzione progressiva della consulenza, l'email 8 è la chiusura del funnel.
