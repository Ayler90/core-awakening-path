                    ...
                    <div>
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        >
                          ...
                          <a
                            href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Core+Foundation+-+prima+live&dates=20260615T100000Z/20260615T120000Z&details=Questa+%C3%A8+la+prima+live+di+Core+Foundation.+Per+accedere+alla+diretta,+accedi+al+canale+Telegram+del+percorso+e+clicca+sul+link+della+diretta."
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        >
                          ...
                          <a
                            href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Core+Foundation+-+seconda+live&dates=20260626T100000Z/20260626T120000Z&details=Questa+%C3%A8+la+seconda+live+di+Core+Foundation.+Per+accedere+alla+diretta,+accedi+al+canale+Telegram+del+percorso+e+clicca+sul+link+della+diretta."
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-xs underline"
                            style={{ color: "#AF2B43" }}
