...
const TELEGRAM_URL = "https://t.me/+dbAhLQt0-j44NWE0";
const DRIVE_URL = "https://drive.google.com/drive/folders/1lgkNuyQ7zkjNkcvYW8GhC515vyKzvAHd";

const GrazieEvolution = () => {
  return (
    <main>
      <PageMeta
        title="Grazie! Sei iscritto/a a CORE Evolution | Officina.MM"
        description="Benvenuto/a in CORE Evolution. Segui le istruzioni per accedere al percorso e unirti al gruppo Telegram dedicato. Officina.MM – Michela e Moreno."
      />
      {/* Banner top */}
      <div
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 max-w-3xl text-center">
          ...
          <h1 className="text-3xl sm:text-5xl font-bold font-display leading-tight text-foreground mb-4">
            ...
            <span className="italic" style={{ color: "#AF2B43" }}>
              Il tuo posto a Core Evolution è confermato
            </span>
          </h1>

          <p className="text-lg text-muted-foreground font-body leading-relaxed mb-4">
            Siamo felicissimi di averti con noi per questo nuovo viaggio verso la massima espressione del tuo Core:
            benvenutə in <strong className="text-foreground">Core Evolution</strong>!
            Dopo aver costruito solide fondamenta con Core Foundation, e aver lavorato sull'endurance in Core Advance,
            ora è il momento di spingere un po' oltre i tuoi limiti, lavorando sulla gestione delle pressioni con esercizi
            ancora più sfidanti e sul rinforzo di tutta la parete addominale, non solo a livello profondo.
          </p>
          ...
          <p className="text-base text-muted-foreground font-body leading-relaxed mb-6">
            ...
            siamo entusiasti di accompagnarti in questo nuovo percorso!
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
              ...
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground font-body text-sm leading-relaxed mb-4">
                    Per accedere a tutti i contenuti giornalieri e partecipare attivamente alla community,
                    clicca sul link qui sotto e iscriviti al canale privato di Core Evolution su Telegram.
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-col gap-5 text-sm text-muted-foreground font-body leading-relaxed">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        >
                          ...
                          <a
                            href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Core+Evolution+-+prima+live&dates=20260615T100000Z/20260615T120000Z&details=Questa+%C3%A8+la+prima+live+di+Core+Evolution.+Per+accedere+alla+diretta,+accedi+al+canale+Telegram+del+percorso+e+clicca+sul+link+della+diretta."
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        >
                          ...
                          <a
                            href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Core+Evolution+-+seconda+live&dates=20260626T100000Z/20260626T120000Z&details=Questa+%C3%A8+la+seconda+live+di+Core+Evolution.+Per+accedere+alla+diretta,+accedi+al+canale+Telegram+del+percorso+e+clicca+sul+link+della+diretta."
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-xs underline"
                            style={{ color: "#AF2B43" }}
                    ...
                    <div>
                      ...
                      <p className="mb-3">
                        Nella cartella Drive trovi i contenuti di Core 101, i Fondamentali di Core Foundation e Advance,
          ...
          <div className="mt-14 text-center">
            <p className="text-base text-muted-foreground font-body leading-relaxed">
              Grazie ancora per aver scelto di continuare a crescere con noi in Core Evolution.
              Non vediamo l'ora di celebrare insieme ogni tuo nuovo traguardo!
            </p>
...
export default GrazieEvolution;
