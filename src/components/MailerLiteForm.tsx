...
#mlb2-39140121 .ml-form-checkboxRow input[type="checkbox"]:checked::after{
  ...
  border:2px solid #AF2B43!important;border-top:none!important;border-left:none!important;
...
#mlb2-39140121.ml-form-embedContainer .ml-form-embedWrapper .ml-form-embedBody .ml-form-embedSubmit button{background-color:#FAB72D!important;border:none!important;border-radius:50px!important;box-shadow:none!important;color:#61438C!important;cursor:pointer;font-family:'Open Sans',Arial,Helvetica,sans-serif!important;font-size:15px!important;font-weight:700!important;line-height:21px!important;height:auto;padding:15px!important;width:100%!important;box-sizing:border-box!important;transition:box-shadow 0.25s ease,background-color 0.25s ease!important}
...
#mlb2-39140121.ml-form-embedContainer .ml-form-embedWrapper .ml-form-embedBody .ml-form-embedSubmit button:hover{background-color:#e9a520!important;box-shadow:0 6px 24px rgba(250,183,45,0.4)!important}
...
#mlb2-39140121 .ml-form-embedSubmit button.primary{background-color:#FAB72D!important;color:#61438C!important;font-size:15px!important;padding:15px!important;border-radius:50px!important;transition:box-shadow 0.25s ease,background-color 0.25s ease!important}
#mlb2-39140121 .ml-form-embedSubmit button.primary::after{content:' →';display:inline-block;transition:transform 0.25s ease}
#mlb2-39140121 .ml-form-embedSubmit button.primary:hover{background-color:#e9a520!important;box-shadow:0 6px 24px rgba(250,183,45,0.4)!important}
    ...
    (window as any).ml_webform_success_39140121 = function () {
      try {
        (window.top as Window).location.href =
          "https://core101.officinamm.com/sei-dentro-training";
      } catch {
